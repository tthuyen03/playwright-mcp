...
(async () => {
    logger.info('Starting Test Case 14: Place Order: Register while Checkout');
    ...
    try {
        ...
        logger.info('Step 19: Clicking Delete Account button');
        await homePage.clickDeleteAccountButton();

        // 20. Verify 'ACCOUNT DELETED!' and click 'Continue' button
        logger.info('Step 20: Verifying account deletion');
        await signupPage.verifyAccountDeleted();

        logger.info('Test Case 14: Place Order: Register while Checkout - PASSED');
    } catch (error) {
        logger.error('Test Case 14: Place Order: Register while Checkout - FAILED');
